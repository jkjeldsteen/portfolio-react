        ...
        <div className='about-wrapper'>
            <div className='about-content'>
                ...
                <p>I also take interest in video game development and sometimes try by myself to develop smaller "indie" games, i've done recreations of popular games like "Asteroids" "Doodle Jump"
                    and "Geometry Dash". You can try some of my games in your browser here: <a href="https://jkjeldsteen.itch.io" target="_blank" rel="noopener noreferrer" style={{color: "#31ebad"}}>Itch.io</a></p>
                ...
                <p>If you wanna know more you should take a look at my <a href="#!" onClick={handleDownload} style={{color: "#31ebad"}}>resumé</a></p>
            </div>
        </div>
    );
}
