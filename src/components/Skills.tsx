...
import unityIcon from "../resources/svg/unity-svgrepo-com.svg";
    ...
    <div className="skills-wrapper">
      <div className="skills-container">
        ...
        <div className="featured-skills">
          ...
          <ul>
            <li>
              <img src={unityIcon} alt="Unity" className="icon featured-icon" />
              <span>Unity</span>
            </li>
            <li>
              <img src={csharpIcon} alt="C#" className="icon featured-icon" />
              <span>C#</span>
            </li>
          </ul>
        </div>
