        ...
        <div className="projects-container">
          <div className="project-card">
            ...
            <p>
              ...
              . I have for example reinterpreted{" "}
              <a
                href="https://jkjeldsteen.itch.io/warthog-defence"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#777a99" }}
              >
              ...
              ,
              <a
                href="https://jkjeldsteen.itch.io/square-jumper"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#777a99" }}
              >
              ...
              , and
              <a
                href="https://jkjeldsteen.itch.io/bouncy-pirate"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#777a99" }}
              >
              ...
              . And then I've also made a couple of my own games. I really think
              you should check out my tower defense inspired game
              <a
                href="https://jkjeldsteen.itch.io/gold-mine-defender"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#777a99" }}
              >
          ...
          >
            <h2>
              Backend Developer Intern at Black Capital Technology (Click me 😉)
            </h2>
            <p>
              July 2024 (Aalborg). As part of my search for a job, I went into
              an internship with Black Capital Technology as a backend developer
              on some internal projects. I gained experience as a backend
              developer using the Go programming language. I was also introduced
              to working in a small team combined of remote and on-site workers.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p>
              August 2023 - October 2023 (Randers). During my computer science
              education, I completed a 10-week company internship at
              NordicScreen in Randers, where I gained valuable experience as a
              full-stack developer. I worked on various tasks and programming
              languages, including JavaScript, TypeScript, React, and PHP.
              Additionally, I participated in the development of an app designed
              for Samsung TV based on Tizen 6.5.
            </p>
          </a>
          <a
          ...
          >
            <h2>
              POC Consent Management Platform for JP/Politiken (Click me 😉)
            </h2>
            <p>
              In the fifth semester of my computer science education, we
              collaborated with JP/Politiken to develop a Proof of Concept for
              an internally owned Consent Management Platform. The system should
              be able to handle the scanning of cookies on a domain and store
              this information in a database. Additionally, it should have an
              admin dashboard to manage cookies on various domains and an
          ...
          <a
            href="https://github.com/BubbleDK/3_semesterprojekt/tree/main"
            target="_blank"
            rel="noopener noreferrer"
            className="project-card"
          >
