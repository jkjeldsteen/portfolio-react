  ...
  return (
    <div className="about-wrapper">
      <div className="about-content">
        ...
        <p>👋</p>
        <p>
          Hey! I’m Jakob Kjeldsteen, a 26-year-old software developer. I’ve completed my Bachelor’s in Software Development with a specialization in Game Development, and I also hold an AP degree in Computer Science from UCN Aalborg, Denmark. I’m now looking for my first full-time software development role, where I can contribute my skills, learn from experienced colleagues, and grow as a developer.
        </p>
        <p>
