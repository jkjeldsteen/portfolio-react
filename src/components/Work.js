    ...
    return (
        <div className="main-content">
            <div className="projects-container">
                ...
                <div className="project-card">
                    <h2>Backend Developer Intern at Black Capital Technology</h2>
                ...
                <div className="project-card">
                    <h2>Full-stack Developer Intern at NordicScreen</h2>
                ...
                <div className="project-card">
                    <h2>POC Consent Management Platform for JP/Politiken</h2>
                ...
                <div className="project-card">
                    <h2>POC Dashboard Tool for Xtellio</h2>
                ...
                <div className="project-card">
                    <h2>Booking System for Internet Café</h2>
                ...
                <div className="project-card">
                    <h2>Gift Solution System for Kop & Kande</h2>
